...
class MpvBinSensor(CoordinatorEntity, BinarySensorEntity):
    ...
    def map_bool_value(self, value: Any) -> bool:
        ...
        match value:
            ...
            case _:
                _LOGGER.warning(
                    "Unexpected value for binary sensor %r: %r", self.entity_id, value
                )
                return bool(value)
...
class MpvBin1Sensor(MpvBinSensor):
    ...
    def map_bool_value(self, value: Any) -> bool:
        ...
        if isinstance(value, int):
            ...
            _LOGGER.warning(
                "Unexpected type for bin1 sensor %r value: %r", self.entity_id, value
            )
            return False
...
class MpvBin2Sensor(MpvBinSensor):
    ...
    def map_bool_value(self, value: Any) -> bool:
        ...
        if isinstance(value, int):
            ...
            _LOGGER.warning(
                "Unexpected type for bin2 sensor %r value: %r", self.entity_id, value
            )
            return False
...
class MpvBin3Sensor(MpvBinSensor):
    ...
    def map_bool_value(self, value: Any) -> bool:
        ...
        if isinstance(value, int):
            ...
            _LOGGER.warning(
                "Unexpected type for bin3 sensor %r value: %r", self.entity_id, value
            )
            return False
